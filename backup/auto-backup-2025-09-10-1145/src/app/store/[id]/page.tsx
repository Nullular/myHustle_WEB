        ...
        <div className="absolute bottom-8 left-5 right-5">
          <div className="flex items-center space-x-4">
            ...
            <div className="w-20 h-20 rounded-2xl bg-white p-2 shadow-lg">
              ...
              <div className={`w-full h-full bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center text-white font-bold text-lg ${shop.logoUrl ? 'hidden' : ''}`}>
                {shop.name.charAt(0)}
              </div>
            </div>
