...
export default function BookingManagementPage() {
  ...
  } = useShopBookingAnalytics(storeId);
  ...
  const isLoading = shopLoading || analyticsLoading || todaysLoading || weeklyLoading;
  ...
  }, [shop, bookingAnalytics, todaysBookings, weeklyBookingData, analyticsLoading, isOwner]);
        Tue: 4,
        Wed: 1,
        Thu: 6,
        Fri: 3,
