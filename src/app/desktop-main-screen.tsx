...
export default function DesktopMainScreen({
  ...
  const filterDrag = useDragScroll<HTMLDivElement>();
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-6">
          ...
          {/* SLEEK FILTER CHIPS - DRAG TO SCROLL (no visible bar) */}
          <div
            ref={filterDrag.ref}
            {...filterDrag.handlers}
            className="flex items-center space-x-3 overflow-x-auto pt-2 pb-4 scrollbar-hide flex-nowrap cursor-grab active:cursor-grabbing select-none"
          >
            ...
            {filterCategories.map((category) => (
              <button
                ...
                } px-5 py-2 rounded-2xl text-sm font-medium whitespace-nowrap transition-all duration-200 hover:scale-105 active:scale-95`}
              >
                {category}
              </button>
            ))}
