        ...
        <div className="neu-card rounded-3xl p-4">
          ...
          <div className="space-y-3">
           ...
           <button
             ...
             className={`w-full mt-4 h-10 rounded-xl bg-blue-600 hover:bg-blue-700 focus:ring-2 focus:ring-blue-400 text-white font-bold flex items-center justify-center space-x-2 shadow-lg transition-all duration-150 ${contactLoading ? 'opacity-60 cursor-not-allowed' : ''}`}
           >
             {contactLoading ? (
             ...
             <span>{contactLoading ? 'Starting chat...' : 'Contact Store Owner'}</span>
           </button>
