...
export default function Home() {
  ...
  const isShopOpen = (shop: any): boolean => {
    if (!shop.openTime24 || !shop.closeTime24) return true; // Assume open if no hours specified
  ...
  const filteredShops = shops.filter(shop => {
    ...
    const matchesCategory = (() => {
      switch (selectedCategory) {
        ...
        case 'Featured': return shop.rating >= 4.5;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-4">
              {/* Cart */}
              <Link href="/cart">
                <NeuButton variant="secondary" className="relative p-2">
              ...
              {user ? (
                    ...
                    <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
                      <div className="py-2">
                        ...
                        {user.userType === 'BUSINESS_OWNER' && (
                          <Link href="/store/create" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                ...
                <div className="space-x-2">
                  <Link href="/login">
                    <NeuButton variant="secondary">Sign In</NeuButton>
                  </Link>
                  <Link href="/signup">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredShops.map((shop) => (
            <NeuCard key={shop.id} className="overflow-hidden hover:shadow-lg transition-shadow duration-200">
              <div className="relative">
                {/* Shop Image */}
        ...
        {/* Test Data Link - Remove in production */}
